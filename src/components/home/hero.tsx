        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                Create <strong>stunning</strong> <span>content</span> <br />
                with <strong>AI</strong> <em className="italic">in seconds</em>
              </h1>
            </motion.div>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Powered by cutting-edge technology from</p>
              <div className="flex items-center justify-center gap-8">
                ...
                <div className="opacity-60 hover:opacity-100 transition-all duration-300">
                  <div className="text-foreground font-semibold text-lg tracking-tight">neon</div>
                </div>
                ...
                {/* TypeScript Logo */}
                <div className="opacity-60 hover:opacity-100 hover:drop-shadow-[0_0_8px_rgba(49,120,198,0.5)] transition-all duration-300">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 24 24"
                  ...
                  >
                    ...
                    <path d="M18.245 7.389h-3.068v9.347h-1.487V7.389h-3.068V6.165h7.623v1.224Z" fill="white"/>
                    <path d="M16.317 13.496c.274 0 .524.045.748.134.224.09.419.214.587.37.167.158.297.344.39.558.094.215.141.449.141.703 0 .259-.047.497-.141.713-.094.217-.223.404-.39.562-.168.159-.363.283-.587.373-.224.09-.474.134-.748.134-.275 0-.525-.045-.748-.134a1.845 1.845 0 0 1-.588-.373 1.78 1.78 0 0 1-.39-.562 1.731 1.731 0 0 1-.141-.713c0-.254.047-.488.141-.703a1.78 1.78 0 0 1 .39-.558 1.85 1.85 0 0 1 .588-.37c.223-.089.473-.134.748-.134Z" fill="white"/>
                  </svg>
                </div>
              </div>
            </div>
